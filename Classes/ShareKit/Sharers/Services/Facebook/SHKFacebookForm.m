...
//  ShareKitCommit
//
//  Created by David Porter on 11/17/10.
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil 
{
	...
	{		
		...
		self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Send to Facebook"
...
{	
	...
	if (textView.text.length == 0)
	{
		...
		[(SHKFacebookForm *)delegate sendForm:self];
